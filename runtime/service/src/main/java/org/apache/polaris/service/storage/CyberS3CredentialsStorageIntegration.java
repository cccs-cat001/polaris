...
public class CyberS3CredentialsStorageIntegration 
  ...
  private static final Logger LOGGER =
      LoggerFactory.getLogger(CyberS3CredentialsStorageIntegration.class);

  public CyberS3CredentialsStorageIntegration(
  ...
  public CyberS3CredentialsStorageIntegration(
    ...
    super(config, CyberS3CredentialsStorageIntegration.class.getName());
